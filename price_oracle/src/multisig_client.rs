...
//! options_market's src/multisig_client.rs: a normal source dependency
//! would link multisig's own #[contractimpl] functions into this
//! contract's wasm and collide on shared names (pause, transfer_admin).
//!
